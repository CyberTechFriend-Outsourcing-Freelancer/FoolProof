...
if((count%6)!=5 && msg.payload.length != 8) { //count가 5가 아닐 때. 즉, ID가 1~5인 경우. 그리고 payload의 길이가 8이 아닌 경우. 즉, http를 통해 받은 명령에 대한 응답값이 아닌 경우
  ...
  return msg ;
} else { //ID가 6인 경우, http를 통해 받은 명령에 대한 응답값인 경우
